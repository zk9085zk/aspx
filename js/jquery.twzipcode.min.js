...
(function (g, m, n, p) {
    ...
    l.prototype = {
        ...
        data: function () {
            var b = this.wrap;
            return "undefined" !== typeof f[b.county.val()] ? f[b.county.val()] : f
        },
        serialize: function () {
            var b = [],
                a = {},
                c = {},
                d = {},
                a = this.container.find("select,input");
        ...
        get: function (b) {
            if ("function" === typeof b) b.call(this, this.wrap);
            else return this.wrap
        },
        set: function (b) {
            var a = g.extend({}, {
                county: "",
        ...
        reset: function (b, a) {
            ...
            switch (a) {
                ...
                default:
                    ...
                    c.district.html('<option value="">\u9109\u93ae\u5e02\u5340</option>');
                    for (d in f) "undefined" !== typeof f[d] && e.push('<option  value="' + d + '">' + d + "</option>");
        ...
        bindings: function () {
            ...
            c.county.on("change.twzipcode", function () {
                ...
                c.district.empty();
                if (k) {
                    if (!0 === a.zipcodeIntoDistrict)
                        for (d in f[k]) "undefined" !== typeof f[k][d] && (e.push('<option value="' + d + '">'), e.push(f[k][d] + " " + d), e.push("</option>"));
                    else
                        for (d in f[k]) "undefined" !== typeof f[k][d] && (e.push('<option value="' + d + '">'), e.push(d), e.push("</option>"));
            ...
            c.district.on("change.twzipcode", function () {
                var b = g(this).val();
                c.county.val() && c.zipcode.val(f[c.county.val()][b]);
                ...
                if (3 === d.length)
                    for (e in f)
                        if ("undefined" !== typeof f[e])
                            for (h in f[e])
                                if ("undefined" !==
                                    typeof f[e][h] && d === f[e][h]) {
                                    c.county.val(e).trigger("change.twzipcode");
                                    c.district.val(h).trigger("change.twzipcode");
                                    break
                                }
            ...
            e = "undefined" !== typeof a.countySel ? a.countySel : "undefined" !== typeof b.role.county.data("value") ? b.role.county.data("value") : a.countySel;
            h = "undefined" !== typeof a.districtSel ?
                a.districtSel : "undefined" !== typeof b.role.district.data("value") ? b.role.district.data("value") : a.districtSel;
            e && (b.wrap.county.val(e).trigger("change.twzipcode"), "undefined" !== typeof f[e][h] && b.wrap.district.val(h).trigger("change.twzipcode"));
        ...
        geoLocation: function () {
            ...
            a && a.getCurrentPosition(function (a) {
                var c = {};
                "coords" in a &&
                    "latitude" in a.coords && "longitude" in a.coords && (c = [a.coords.latitude, a.coords.longitude], g.getJSON("https://maps.googleapis.com/maps/api/geocode/json", {
                        key: d.googleMapsKey,
                        sensor: !1,
                        latlng: c.join(",")
                    }, function (a) {
                        var c = "";
                        a && "undefined" !== typeof a.results && "undefined" !== typeof a.results[0].address_components && "undefined" !== typeof a.results[0].address_components[0] && (c = a.results[0].address_components[a.results[0].address_components.length - 1].long_name) && b.wrap.zipcode.val(c.toString()).trigger("blur.twzipcode")
                    }))
            },
                function (a) {
                    console.error(a)
        ...
        init: function () {
            var b = this.container,
                ...
                d = c.county.data("name") || a.countyName,
                e = c.district.data("name") || a.districtName,
                f = c.zipcode.data("name") || a.zipcodeName,
                k = c.zipcode.data("placeholder") || a.zipcodePlaceholder,
                l = c.zipcode.data("readonly") || a.readonly;
            g("<input/>").attr({
                type: "text",
                name: f,
                placeholder: k
            }).prop("readonly", l).addClass(c.zipcode.data("style") || ("undefined" !== typeof a.css[2] ? a.css[2] : "")).appendTo(c.zipcode.length ? c.zipcode : b);
            g("<select/>").attr("name", d).addClass(c.county.data("style") || ("undefined" !==
                typeof a.css[0] ? a.css[0] : "")).appendTo(c.county.length ? c.county : b);
            g("<select/>").attr("name", e).addClass(c.district.data("style") || ("undefined" !== typeof a.css[1] ? a.css[1] : "")).appendTo(c.district.length ? c.district : b);
