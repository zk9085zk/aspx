<%@ Page Language="C#" AutoEventWireup="true" CodeFile="memberregister.aspx.cs" Inherits="webs_member_memberregister" %>
        ...
        <div class="container col-md-8 col-md-offset-2" style="margin-top: 60px">
            ...
            <div class=" col-md-12 w3-card-12" style="border-style: double; background-color: whitesmoke;">
                ...
                <div class="col-md-12 text-center" style="margin-top: 40px">
                    ...
                    <asp:Button ID="Button14" runat="server" Text="取消" class="button button4 w3-pink w3-card-12" Style="background-color: #FA8072" Height="50px" OnClick="Button14_Click" />
                    <script>
