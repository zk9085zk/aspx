<%@ Page Language="C#" AutoEventWireup="true" CodeFile="memberbuy.aspx.cs" Inherits="webs_memberbuy" %>
        ...
        <div id="page-content-wrapper" >
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <h1 class="page-header" style="font-family: Microsoft JhengHei">購買紀錄</h1>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            <asp:TextBox ID="datepicker" runat="server" class="col-md-12"></asp:TextBox>
                                        </div>
                                        <div class="col-md-1">
                                        ...
                                        <div class="col-md-3">
                                            <asp:TextBox ID="datepicker2" runat="server" class="col-md-12"></asp:TextBox>
                                        </div>
                                        
                                        <div class="col-md-2">
                                            <asp:Button ID="Button8" class="w3-blue" runat="server" Text="查詢" OnClick="Button8_Click"></asp:Button>
                                        </div>
                                    </div>
                    ...
                    <div style="font-size:18px">           
                     <asp:Label class="w3-green" ID="Label14" runat="server" Text="//此為商品詳細"></asp:Label>
                        </div>  
