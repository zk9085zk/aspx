<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editmember.aspx.cs" Inherits="webs_member_editmember" %>
        ...
        <div id="page-content-wrapper" >
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <h1 class="page-header" style="font-family: Microsoft JhengHei">修改資料</h1>
             <div class="w3-row-padding">
                ...
                <div class="w3-third ">
                    ...
                    <div class="form-group"> 
                      <asp:Label CssClass="col-sm-4 " ID="Label5" runat="server" Text="手機：" AssociatedControlID="TextBox1"></asp:Label> 
                      <div class="col-sm-8">
                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="手機" ></asp:TextBox>
                      </div>
                    </div>
                    ...
                    <div class="form-group"> 
                      <asp:Label CssClass="col-sm-4" ID="Label6" runat="server" Text="生日：" AssociatedControlID="TextBox2"></asp:Label> 
                      <div class="col-sm-8">
                        <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="生日"></asp:TextBox>
                      </div>
                    </div>
                     ...
                     <div class="form-group"> 
                      <asp:Label CssClass="col-sm-4" ID="Label7" runat="server" Text="郵遞區號：" AssociatedControlID="TextBox3"></asp:Label> 
                      <div class="col-sm-8">
                        <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="郵遞區號"></asp:TextBox>
                      </div>
                    </div>
                     ...
                     <div class="form-group"> 
                      <asp:Label CssClass="col-sm-4" ID="Label8" runat="server" Text="城市：" AssociatedControlID="TextBox4"></asp:Label> 
                      <div class="col-sm-8">
                        <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="城市"></asp:TextBox> 
                      </div>
                    </div>
                     ...
                     <div class="form-group"> 
                      <asp:Label CssClass="col-sm-4" ID="Label11" runat="server" Text="地區：" AssociatedControlID="TextBox5"></asp:Label> 
                      <div class="col-sm-8">
                        <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="地區"></asp:TextBox> 
                      </div>
                    </div>
                     ...
                     <div class="form-group"> 
                      <asp:Label CssClass="col-sm-4" ID="Label12" runat="server" Text="地址：" AssociatedControlID="TextBox6"></asp:Label> 
                      <div class="col-sm-8">
                        <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="地址"></asp:TextBox> 
                      </div>
                    </div>  
                    ...
                    <table>
                        <tr>
                            <td>
                      <asp:Button ID="Button8" runat="server"  OnClick="Button8_Click" onclientclick="return confirm('確定要修改嗎?')"  Text="修改" style="width:100px;height:50px;" CssClass="btn btn-danger btn-block " />
                            </td>

                             <td>
                      <asp:Button ID="Button1" runat="server"  OnClick="Button1_Click"   Text="取消修改" style="width:100px;height:50px;" CssClass="btn btn-danger btn-block " />
                             </td>
                         </tr>
                     </table>
