<%@ Page Language="C#" AutoEventWireup="true" CodeFile="finish.aspx.cs" Inherits="webs_finish" %>
                                     ...
                                     <div class="row">
                                          ...
                                          <div class="col-md-12" style="text-align:center">
                                              <div style="font-size:28px">
                                                  ...
                                                  <asp:Button ID="Button2" runat="server" Text="歐付寶付款" Visible="false" OnClick="Button2_Click" CssClass="button button1"/>
                                              </div>
                                         </div>
