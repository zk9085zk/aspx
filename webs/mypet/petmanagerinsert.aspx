<%@ Page Language="C#" AutoEventWireup="true" CodeFile="petmanagerinsert.aspx.cs" Inherits="webs_petmanagerupdate" %>
            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div id="select_survey" class="col-md-8">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="col-md-12 ">
                                    ...
                                    <div class="form-group" >
                                        <h3>
                                            <label for="petname">毛小孩大名(必填)：</label></h3>
                                ...
                                <div class="col-md-12 ">
                                    <div class="form-group">
                                        ...
                                        <select id="ddl_Allergens">
                                            <option value="無資料!!">請選擇一種</option>
                                            <option class="icon-checkmark" value="yes">有過敏源</option>
                                            <option class=" icon-x" value="no">無過敏源</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <div class="col-md-12 " style="">
                                     <h3><label for="birthday">寵物生日(必填)：</label></h3>
                                   ...
                                   <asp:TextBox Style="margin-top: 40px;" CssClass="form-control" ID="datepicker" runat="server" ></asp:TextBox>
                                ...
                                <div class="col-md-12 " style="">
                                    <div class="form-group">
                                        <h3>
                                            <label>毛小孩體重(公斤)：</label></h3>
                                        <asp:TextBox type="text" Style="margin-top: 40px" CssClass="form-control" ID="TextBox2" runat="server" placeholder="公斤"></asp:TextBox>
                                    </div>
                                </div>
                        ...
                        <div class="row text-center" style="margin-bottom: 100px; margin-top: 30px;">
                            <div class="col-md-12" style="">
                                <asp:Button CssClass="btn btn-primary btn-lg" ID="Buttonfinish" OnClick="Buttonfinish_Click" runat="server" Text="確認提交" Style="margin-top: 15px; height: 50px;" />
                            </div>
                        </div>
                    </div>
