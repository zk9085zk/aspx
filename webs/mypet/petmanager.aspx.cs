...
public partial class webs_petmanager : System.Web.UI.Page
{
    /*資料參數*/
    ...
    private void _btn_choice_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < int_pet; i++)
        {
            ...
            {
                Session["str_petmemberid"] = str_memberid[i];
                Response.Redirect("petdetail.aspx");
            }
        }
    }
