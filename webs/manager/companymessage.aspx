<%@ Page Language="C#" AutoEventWireup="true" CodeFile="companymessage.aspx.cs" Inherits="webs_manager_companymessage" %>
    ...
    <form id="form1" runat="server">
        ...
        <nav class="w3-sidenav w3-collapse w3-card-2 w3-animate-left" style="width: 18%;background-color: #00796B" id="mySidenav">
          ...
          <div class="c navbar-fixed-top">
            ...
            <h1 class="page-header" style="font-family: Microsoft JhengHei">留言回覆</h1>
                 ...
                 <table style="width:100%">
                     ...
                     <tr>
                           ...
                           <td style="padding:15px"><asp:TextBox ID="TextBox1" runat="server" class="w3-input w3-border" placeholder="標題"></asp:TextBox></td> 
 
                     </tr>
                     <tr>
                           <td style="padding:15px"><asp:Label ID="Label12" runat="server"><b>內容:</b></asp:Label></td>
            ...
            <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                     <asp:Button ID="Button1" OnClick="Button11_Click" runat="server" Text="回留言板" Style="width: 120px; height: 50px;" CssClass="btn btn-lg btn-primary btn-block"  />
                                </div>
                                 <div class="col-md-2">
                                     <asp:Button ID="Button15" OnClick="Button15_Click" onclientclick="return confirm('確定要回覆嗎?')" runat="server" Text="確認回覆" Style="width: 120px; height: 50px;" CssClass="btn btn-lg btn-primary btn-block"  />
                                </div>
