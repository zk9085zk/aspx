<%@ Page Language="C#" AutoEventWireup="true" CodeFile="backmanagercommodityinsert.aspx.cs" Inherits="webs_manager_backmanagercommodityinsert" %>
        ...
        <div class="row" style="padding-top: 100px;margin-left:23%;width:70%">
                      ...
                      <div class="aa">
                        <table  class="table table-striped">
                          ...
                          <!--          <asp:FileUpload ID="FileUpload1" runat="server" Text="上傳寵物圖片" onchange="previewFile()" />-->
                                </div>
                                <div class="col-md-4">
                                <!--      <asp:Image ID="Preview" runat="server" Width="80" Height="80"  />-->
                                </div>
                                <div class="col-md-2">
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" onclientclick="return confirm('確定要新增嗎?')" Text="確定新增"  CssClass="button button1" />
                                </div>
                                <div class="col-md-2">
                                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click"  Text="取消新增"  CssClass="button button1" />
                                </div>
                                <br />
                             </div>
                            </div>
