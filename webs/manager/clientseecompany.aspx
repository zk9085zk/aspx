<%@ Page Language="C#" AutoEventWireup="true" CodeFile="clientseecompany.aspx.cs" Inherits="webs_manager_clientseecompany" %>
        ...
        <div id="page-content-wrapper" >
            ...
            <div class="container">
                ...
                <div class="row">
                                 ...
                                 <h1 class="page-header" style="font-family: Microsoft JhengHei">客服回覆</h1>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10">
                                 ...
                                 <div class="col-md-2">
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="回留言" Style="width: 120px; height: 50px;" CssClass="btn btn-lg btn-primary btn-block" />
                                </div>
