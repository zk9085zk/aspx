<%@ Page Language="C#" AutoEventWireup="true" CodeFile="backmanagerorder.aspx.cs" Inherits="webs_manager_backmanagerorder" %>
        ...
        <nav class="w3-sidenav w3-collapse w3-card-2 w3-animate-left" style="width: 18%;background-color: #00796B" id="mySidenav">
          ...
          <div class="c navbar-fixed-top">
                ...
                <div class="row" style="padding-top: 100px;margin-left:23%;width:70%">
                        ...
                        <h1 class="page-header" style="font-family: Microsoft JhengHei;text-align:left">查詢訂單</h1>
                        <div class="aa">
