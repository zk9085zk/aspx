<%@ Page Language="C#" AutoEventWireup="true" CodeFile="backmanagersearchpet.aspx.cs" Inherits="webs_backmanagersearchpet" %>
  ...
  <form id="form1" runat="server">
        ...
        <nav class="w3-sidenav w3-collapse w3-card-2 w3-animate-left" style="width: 18%;background-color: #00796B" id="mySidenav">
          ...
          <div class="c navbar-fixed-top">
            ...
            <h1 class="page-header" style="font-family: Microsoft JhengHei">查詢會員寵物資料</h1>
        ...
        <div class="col-md-9 w3-card-12" style="margin-top: 20px">
            <asp:Label class="w3-green" ID="Label14" runat="server" Text="//此為會員寵物資料"></asp:Label>
            <br />   
            <br />
