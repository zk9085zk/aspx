<%@ Page Language="C#" AutoEventWireup="true" CodeFile="analysis.aspx.cs" Inherits="webs_manager_analysis" %>
   ...
   <form id="form1" runat="server">
       ...
       <nav class="w3-sidenav w3-collapse w3-card-2 w3-animate-left" style="width: 18%;background-color: #00796B" id="mySidenav">
          ...
          <div class="c navbar-fixed-top">
            ...
            <div class="row" style="padding-top: 100px;margin-left:23%">
   
            <h1 class="page-header" style="font-family: Microsoft JhengHei">分析</h1>
            
                <div style="width:80%;margin-left:5%">
                    <table style="text-align:center;font-size:30px;font-weight:bold">
                        <tr>
                            <td style="border:3px #0000FF solid;width:200px">
                                 <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/registered.jpg" OnClick="ImageButton1_Click" CssClass="imgb"/>
                             <br/>會員註冊
                            </td>
                            <td style="width:10px">
                            ...
                            <td  style="border:3px #0000FF solid;width:200px">
                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/img/sale.jpg" OnClick="ImageButton2_Click" CssClass="imgb"/>
                           <br/>保健食品銷售
                            </td>
                            <td style="width:10px">
                            ...
                            <td  style="border:3px #0000FF solid;width:200px">
                                <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/img/formula.jpg" OnClick="ImageButton3_Click" CssClass="imgb"/>
                           <br/>客製化配方統計
                            </td>
                        </tr>
