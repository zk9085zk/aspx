<%@ Page Language="C#" AutoEventWireup="true" CodeFile="billboard.aspx.cs" Inherits="webs_billboard" %>
            ...
            <ul class="nav sidebar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li> <a href="/webs/fodder/fodder.aspx" style="color: white;">訂製我的菜</a></li>
        ...
        <div id="page-content-wrapper" >
            ...
            <div class="container" >
                ...
                <div class="row">
                                ...
                                <h1 class="page-header" style="font-family: Microsoft JhengHei">公告</h1>

                       

                        <table class="table table-striped">
                          <tr>
                            <th> <asp:Label ID="Label3" runat="server" Text="時間："></asp:Label> </th>
                            <th> <asp:Label ID="Label4" runat="server" Text=""></asp:Label> </th>
                          </tr>
                          <tr>
                            <td> <asp:Label ID="Label5" runat="server" Text="類別："></asp:Label> </td>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-10">
                                 ...
                                 <div class="col-md-2">
                                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="回首頁" Style="width: 120px; height: 50px;" CssClass="btn btn-lg btn-primary btn-block" />
                                </div>
